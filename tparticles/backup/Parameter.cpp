...
Parameter::Parameter()
{
	...
	dt=-0.2183772/sqrt(4.*pi); //time step
	...
	stepMax=1250000; // the max number of time step
	stepPrint=250;//print out each stepPrint steps
	...
	zmax=2.236068e+03;
	ymax=3.100868e-01;
	saveto="/Users/yanhualiu/Dropbox/viewer/tparticles/data/test"+timestep+"_4.dat";//"/home/yanhua/Desktop/test/test.dat";
